      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 기관투자자(N)이 M% 이상 보유 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="holder" method="post">
              <div class="ibox-content">                 
						<div class="col-md-2 input-group">
                      	...
                      	<div class="col-md-2 input-group">
                			<label class="font-normal">기관투자자(N)</label>           	
		                    <div>
	                          <select class="select2_demo_1 form-control" name="holder" id="holder">
	                              <option value="KK" 
	                              	<c:out value="${vo.holder eq 'KK'?'selected':''}"/>>
	                                	국내/국외 기관투자자</option>
	                              <option value="국민연금" 
	                              <c:out value="${vo.holder eq '국민연금'?'selected':''}"/>>
	                              	국민연금</option>
	                              <option value="KB자산운용" 
	                              <c:out value="${vo.holder eq 'KB자산운용'?'selected':''}"/>>
	                              	KB자산운용</option>
	                              <option value="신영자산운용" 
	                              <c:out value="${vo.holder eq '신영자산운용'?'selected':''}"/>>
	                              	신영자산운용</option>
	                              <option value="한국투자밸류" 
	                              <c:out value="${vo.holder eq '한국투자밸류'?'selected':''}"/>>
	                              	한국투자밸류</option>	                              		                              	
	                          </select>
                      		</div>
						</div>
						<div class="col-md-2 input-group">
		                    <label class="font-normal">보유율(M)</label> 
		                    <div>
                          	<input type="text" name="rateM" placeholder="RATE" id="rateM" value='${vo.rateM}'
                                 class="form-control">
                      		</div>
                      	</div>
