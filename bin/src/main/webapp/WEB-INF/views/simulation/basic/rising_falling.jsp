      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 최근 N 거래일동안 M% 이상 상승/하락한 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="rising_falling" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">최근기간(N)</label> 
		                    <div>
                          	<input type="text" name="duration" placeholder="DURATION" id="duration" value='${vo.duration}'
                                 class="form-control">
                      		</div>
                      	</div>
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">상승률/하락률(M)</label> 
		                    <div>
                      	...
                      	<div class="col-md-2 input-group">
                			<label class="font-normal">상승/하락</label>           	
		                    <div>
     ...
     <div class="ibox float-e-margins">
         ...
         <div class="ibox-content">
          ...
          <tr>
              ...
              <th>전일가대비</th>
              <th>전일거래량대비</th>
              <th>${vo.sign eq '1'?'기간상승률':'기간하락률'}</th>
              <th>시가총액(억)</th>
              <th>년매출액(억)</th>
              <th>영업이익률</th>
              <th>시가배당률</th>
...
<td>${stockVO.rate1 > 0.0 ? "<span style='color:red'>" : "<span style='color:blue'>"} ${stockVO.rate1 }</span> </td>
<td>${stockVO.total}</td>
<td>${stockVO.sales}</td>
