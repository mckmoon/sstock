      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 최근 N 거래일동안 연속 상승/하락한 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="cont_rising_falling" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">연속일(N)</label> 
		                    <div>
	                          <select class="select2_demo_1 form-control" name="duration" id="duration">
	                              <option value="3" 
	                              	<c:out value="${vo.duration eq '3'?'selected':''}"/>>
	                              	연속3일 </option>	                              
	                              <option value="5" 
	                              	<c:out value="${vo.duration eq '5'?'selected':''}"/>>
	                              	연속5일 </option>
	                              <option value="7" 
	                              	<c:out value="${vo.duration eq '7'?'selected':''}"/>>
	                              	연속7일 </option>
	                              <option value="9" 
	                              	<c:out value="${vo.duration eq '9'?'selected':''}"/>>
	                              	연속9일 </option>	                                      
	                           </select>
                      		</div>
                      	</div>
     ...
     <div class="ibox float-e-margins">
         ...
         <div class="ibox-content">
          ...
          <tr>
              ...
              <th>전일가대비</th>
              <th>전일거래량대비</th>
			  <th>${vo.sign eq '1'?'연속일 상승률':'연속일 하락률'}</th>
              <th>시가총액(억)</th>
              <th>년매출액(억)</th>
              <th>영업이익률</th>
              <th>시가배당률</th>
