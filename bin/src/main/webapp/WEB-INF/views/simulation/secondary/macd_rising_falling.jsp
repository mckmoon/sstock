      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, MACD 상승/하락 추세
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="macd_rising_falling" method="post">
              <div class="ibox-content">                 
						<div class="col-md-3 input-group">
                      	...
                      	<div class="col-md-2 input-group">
                			<label class="font-normal">추세</label>           	
		                    <div>
