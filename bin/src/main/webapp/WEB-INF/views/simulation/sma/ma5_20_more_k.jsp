      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 기간내 MA(5,20) 복수번 돌파
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="ma5_20_more_k" method="post">
              <div class="ibox-content">                 
						...
						<div class="col-md-1 input-group">
		                    <label class="font-normal">기간</label> 
		                    <div>
						...
						<div class="col-md-1 input-group">
		                    <label class="font-normal">돌파횟수</label> 
		                    <div>
                          	<input type="text" name="count" placeholder="COUNT" id="rate" value='${vo.count}'
                                 class="form-control">
                      		</div>
                      	</div>
                      	<div class="col-md-1 input-group">
                			<label class="font-normal">상향/하향</label>           	
		                    <div>
