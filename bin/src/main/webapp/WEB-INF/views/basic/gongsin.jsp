      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 공매도량/신용잔고(N)이 M% 이상 증가한 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="gongsin" method="post">
              <div class="ibox-content">                 
						<div class="col-md-2 input-group">
                      	...
                      	<div class="col-md-1 input-group">
                			<label class="font-normal">공매도/신용(N)</label>           	
		                    <div>
						...
						<div class="col-md-2 input-group">
		                    <label class="font-normal">증가율(M)</label> 
		                    <div>
     ...
     <div class="ibox float-e-margins">
         ...
         <div class="ibox-content">
          ...
          <tr>
              ...
              <th>전일가대비</th>
              <th>전일거래량대비</th>
              <th>${vo.sign eq '1'?'공매도증가율':'신용증가율'}</th>
              <th>시가총액(억)</th>
              <th>년매출액(억)</th>
              <th>영업이익률</th>
              <th>시가배당률</th>
