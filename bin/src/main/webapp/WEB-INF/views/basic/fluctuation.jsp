      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, N 거래일 주가 변동이 M% 이상/이하인 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="fluctuation" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">변동률(M)</label> 
		                    <div>
...
<td><span style='color:blue'>${stockVO.rate1}</span> &#126;&#126; <span style='color:red'>${stockVO.rate2}</span></td>
<td>${stockVO.total}</td>
<td>${stockVO.sales}</td>
