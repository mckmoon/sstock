      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 패턴에 해당하는 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="pattern_analysis" method="post">
              <div class="ibox-content">                 
						<div class="col-md-3 input-group">
                      	...
                      	<div class="col-md-2 input-group">
                			<label class="font-normal">패턴</label>           	
		                    <div>
	                          <select class="select2_demo_1 form-control" name="sign" id="sign">
	                              ...
	                              <option value="3" 
	                              <c:out value="${vo.sign eq '3'?'selected':''}"/>>
	                              	단기 하락 추세 중 최근 반등
	                              </option>
	                              <option value="4" 
	                              	<c:out value="${vo.sign eq '4'?'selected':''}"/>>
	                              	장기 횡보 중 최근 반등
	                              </option>
	                              <option value="5" 
	                              <c:out value="${vo.sign eq '5'?'selected':''}"/>>
	                              	중기 횡보 중 최근 반등
	                              </option>
	                              <option value="6" 
	                              <c:out value="${vo.sign eq '6'?'selected':''}"/>>
	                              	단기 횡보 중 최근 반등
	                              </option>
	                          </select>
                      		</div>
