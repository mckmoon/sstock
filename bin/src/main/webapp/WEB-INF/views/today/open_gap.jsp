      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>conditions: 기준일 D, 전일 종가 대비 시초가 M% 이상 상승/하락한 종목</h5>
              ...
              <form role="form" class="form-inline" action="open_gap" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">M: 갭변화율(%)</label> 
		                    <div>
