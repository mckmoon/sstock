...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <strong>250일/500일 최고가/최저가 갱신</strong>
            </li>
        </ol>
    </div>
	<div class="col-lg-2">
      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, N 거래일 최저가/최고가 갱신 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="renew_low_high" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-1 input-group">
                      	...
                      	<div class="col-md-2 input-group">
                			<label class="font-normal">최저가/최고가</label>           	
		                    <div>
