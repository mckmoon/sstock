      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>Screen${dto.sno } conditions: 최근 N일동안 외국인이 연속 매수한 종목</h5>
              ...
              <div class="ibox-content">
                  <form role="form" class="form-inline" action="/screen/screen7" method="post">
                    ...
                    <div class="col-md-3" id="data_1">
                      ...
                      <div class="col-md-2">
                          <label for="duration">DURATION (N)</label>
