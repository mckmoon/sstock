      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>Screen${dto.sno } conditions: 기준일 D, 이전 N거래일 주가 변동이 M% 이하인 종목</h5>
              ...
              <div class="ibox-content">
                  <form role="form" class="form-inline" action="/screen/screen6" method="post">
                    ...
                    <div class="col-md-3" id="data_1">
                      ...
                      <div class="col-md-2">
                          <label for="total">M: CHANGE RATE</label>
                          <input type="text" name="ref_rate" placeholder="CHANGE RATE" id="ref_rate" value='${dto.ref_rate}'
                                 class="form-control">
                      </div>
