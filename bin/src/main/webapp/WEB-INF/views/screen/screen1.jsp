      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>Screen${dto.sno } conditions: 기준일 D, 이전 N거래일 최저점 대비 M% 이하 상승한 종목</h5>
              ...
              <div class="ibox-content">
                  <form role="form" class="form-inline" action="/screen/screen1" method="post">
                    ...
                    <div class="col-md-3" id="data_1">
                      ...
                      <div class="col-md-2">
                          <label for="total">M: UPRATE</label>
                          <input type="text" name="ref_rate" placeholder="UPRATE" id="ref_rate" value='${dto.ref_rate}'
                                 class="form-control">
                      </div>
