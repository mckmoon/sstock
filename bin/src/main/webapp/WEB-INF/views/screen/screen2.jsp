      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>Screen${dto.sno } conditions: 기준일 D, 이전 N거래일 최고점 대비 M% 이상 하락한 종목</h5>
              ...
              <div class="ibox-content">
                  <form role="form" class="form-inline" action="/screen/screen2" method="post">
                    ...
                    <div class="col-md-3" id="data_1">
                      ...
                      <div class="col-md-2">
                          <label for="total">M: DOWNRATE (%)</label>
                          <input type="text" name="ref_rate" placeholder="DOWNRATE" id="ref_rate" value='${dto.ref_rate}'
                                 class="form-control">
                      </div>
