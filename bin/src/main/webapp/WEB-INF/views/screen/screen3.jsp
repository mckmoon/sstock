      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>Screen${dto.sno } conditions: 기준일 D, 대주주 N이 M% 이상 보유한 종목</h5>
              ...
              <div class="ibox-content">
                  <form role="form" class="form-inline" action="/screen/screen3" method="post">
                    ...
                    <div class="col-md-3" id="data_1">
                      ...
                      <div class="col-md-2">
                          <label for="duration">N: HOLDER</label>
                          <input type="text" name="holder" placeholder="holder" id="holder" value='${dto.holder}'
                                 class="form-control">
                      </div>
                      <div class="col-md-2">
                          <label for="total">M: HOLD RATE (%)</label>
                          <input type="text" name="ref_rate" placeholder="hold rate" id="ref_rate" value='${dto.ref_rate}'
                                 class="form-control">
                      </div>
