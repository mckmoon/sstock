      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, N 거래일동안 외국인 연속 매수/매도 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="foreign_buying_selling" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-1 input-group">
                      	...
                      	<div class="col-md-2 input-group">
                			<label class="font-normal">매수/매도</label>           	
		                    <div>
