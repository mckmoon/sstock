      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 10일-투자심리선이 M% 에서 상승/하락 전환
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="psychology_line10_updown" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">기준선(M,%)</label> 
		                    <div>
                      	...
                      	<div class="col-md-2 input-group">
                			<label class="font-normal">상승전환/하락전환</label>           	
		                    <div>
