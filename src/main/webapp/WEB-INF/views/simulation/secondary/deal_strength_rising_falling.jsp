      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 체결강도가 전일대비 M% 이상 상승/하락한 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="deal_strength_rising_falling" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">변화율(M,%)</label> 
		                    <div>
