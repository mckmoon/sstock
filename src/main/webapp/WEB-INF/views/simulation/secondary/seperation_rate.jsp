      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, N이평선-주가 이격률
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="seperation_rate" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-1 input-group">
		                    <label class="font-normal">이동평균선(N) </label> 
		                    <div>
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">이격률(M,%)</label> 
		                    <div>
