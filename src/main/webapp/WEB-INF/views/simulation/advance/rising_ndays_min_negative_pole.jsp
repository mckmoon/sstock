...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-4">
        ...
        <ol class="breadcrumb">
            ...
            <li>고급분석</li>
            <li class="active">
                <strong>기간 최저가 대비 상승후, 음봉</strong>
            </li>
        </ol>
    </div>
	<div class="col-lg-2">
      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, N 거래일 최저가 대비 M% 이상 상승후, 당일 K% 이상 하락한 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="rising_ndays_min_negative_pole" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-1 input-group">
		                    <label class="font-normal">기간(N) 최저가</label> 
		                    <div>
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">상승률(M)</label> 
		                    <div>
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">당일 하락률(K)</label> 
		                    <div>
