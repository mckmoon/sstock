      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 당일 거래량이 N 거래일 평균거래량 대비 M% 이상/이하 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="volume_rate_ndays_avg" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">기간평균거래량(N)</label> 
		                    <div>
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">비율(M)</label> 
		                    <div>
                      	...
                      	<div class="col-md-2 input-group">
                			<label class="font-normal">이상/이하</label>           	
		                    <div>
