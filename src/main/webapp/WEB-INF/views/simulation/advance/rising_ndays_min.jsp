      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 최근 N 거래일 최저가 대비 M% 이상/이하 상승한 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="rising_ndays_min" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">기간최저가(N)</label> 
		                    <div>
