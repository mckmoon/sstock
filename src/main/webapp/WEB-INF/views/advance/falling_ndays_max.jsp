      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 최근 N 거래일 최고가 대비 M% 이상/이하 하락한 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="falling_ndays_max" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">기간최고가(N)</label> 
		                    <div>
