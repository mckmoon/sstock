      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, N 거래일동안 외국인 지분율이 M% 이상 증가/하락한 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="foreign_rate" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">지분율(M)</label> 
		                    <div>
                      	...
                      	<div class="col-md-2 input-group">
                			<label class="font-normal">증가/하락</label>           	
		                    <div>
...
<td>${stockVO.rate1}</td>
<td>${stockVO.rate2 > 0.0 ? "<span style='color:red'>" : "<span style='color:blue'>"} ${stockVO.rate2 }</span> </td>
<td>${stockVO.total}</td>
<td>${stockVO.sales}</td>
