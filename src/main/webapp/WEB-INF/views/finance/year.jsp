  ...
  <div class="row">
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              ...
              <form role="form" class="form-inline" action="year" method="post">
              <div class="ibox-content">                 
		                <div class="col-md-1 input-group">
		                    <label class="font-normal">기준년도</label> 
		                    <div>
	                          <select class="select2_demo_1 form-control" name="basedate" id="basedate">
	                              <option value="20131201" 
	                              	<c:out value="${vo.basedate eq '20131201'?'selected':''}"/>>
	                              	2013년</option>
	                              <option value="20141201" 
	                              	<c:out value="${vo.basedate eq '20141201'?'selected':''}"/>>
	                              	2014년</option>
