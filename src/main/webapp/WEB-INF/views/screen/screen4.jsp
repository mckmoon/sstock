      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>Screen${dto.sno } conditions: 기준일 D, 전일대비 공매도 거래량이 M% 이상 증가한 종목</h5>
              ...
              <div class="ibox-content">
                  <form role="form" class="form-inline" action="/screen/screen4" method="post">
