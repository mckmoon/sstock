      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, 체결강도가 M% 이상/이하인 종목
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="deal_strength" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-1 input-group">
		                    ...
		                    <div>
	                          <select class="select2_demo_1 form-control" name="duration" id="duration">
	                              <option value="1" 
	                              	<c:out value="${vo.duration eq '1'?'selected':''}"/>>
	                              	당일강도 </option>
	                              <option value="5" 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">강도(M,%)</label> 
		                    <div>
