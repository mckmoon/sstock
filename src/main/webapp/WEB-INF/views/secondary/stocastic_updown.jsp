...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-4">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <strong>Stocastic Slow</strong>
            </li>
            <li class="active">
                <strong> SlowD M% 돌파</strong>
            </li>
        </ol>
    </div>
	<div class="col-lg-2">
      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>기준일 D, SlowD M% 상향돌파/하향돌파
                  
				  </h5>
              </div>
              <form role="form" class="form-inline" action="stocastic_updown" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">지표율(M)</label> 
		                    <div>
