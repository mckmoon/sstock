      ...
      <div class="col-lg-12">
          <div class="ibox float-e-margins">
              <div class="ibox-title">
                  <h5>conditions: 기준일 D, 전일 거래량 대비 M% 이상 증가/감소 종목</h5>
              ...
              <form role="form" class="form-inline" action="volume_rising_falling" method="post">
              <div class="ibox-content">                 
		                ...
		                <div class="col-md-2 input-group">
		                    <label class="font-normal">M: 변화율(%)</label> 
		                    <div>
                      	...
                      	<div class="col-md-2 input-group">
                			<label class="font-normal">증가/감소</label>           	
		                    <div>
